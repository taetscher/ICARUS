...
def mapDensityFromImage():
    ...
    #plot the map
    map = plt.imshow(npimg[:,:,0], origin='upper', extent=[-180, 180, -86, 86], alpha=0.5, cmap=c_map, transform=proj, vmax=300)
    ...
    #label the colorbar
    bar.set_label("Expected Count per square kilometer", labelpad=20, fontsize=12)
